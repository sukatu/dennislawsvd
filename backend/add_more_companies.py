#!/usr/bin/env python3
"""
Script to add more companies to the database with comprehensive data
"""
    ...
    companies_data = [
        ...
        },
        {
            ...
            'directors': [
                ...
                {
                    'name': 'Mr. Yolanda Cuba',
                    'address': '456 Airport Residential, Accra',
                    'nationality': 'South African',
                    'occupation': 'Regional Director',
                    'email': 'yolanda.cuba@vodafone.com.gh',
                    'contact': '+233-244-012345',
                    'tax_identification_number': 'P0000123456',
                    'other_directorship': ['Vodafone Group Plc']
                }
            ],
            'secretary': {
        ...
        },
        {
            ...
            'directors': [
                ...
                {
                    'name': 'Ms. Sven Lunsche',
                    'address': '456 Airport City, Accra',
                    'nationality': 'South African',
                    'occupation': 'Mining Executive',
                    'email': 'sven.lunsche@goldfields.com.gh',
                    'contact': '+233-244-345678',
                    'tax_identification_number': 'P0003456789',
                    'other_directorship': ['Gold Fields Limited']
                }
            ],
            'secretary': {
            ...
            'shareholders': [
                ...
                },
                {
                    ...
                    'address': 'Tema Oil Refinery, Tema',
                    'nationality': 'Ghanaian',
                    'occupation': 'State Corporation',
                    'email': 'info@gnpcghana.com',
                    'contact': '+233-303-234567',
                    'tax_identification_number': 'G0002345678',
                    'shares_alloted': 2000000000,
                    'consideration_payable': 'Cash'
                }
            ],
            'other_linked_companies': [
        ...
        },
        {
            ...
            'directors': [
                ...
                {
                    'name': 'Ms. Adiki Ayitevie',
                    'address': '456 East Legon, Accra',
                    'nationality': 'Ghanaian',
                    'occupation': 'Environmental Engineer',
                    'email': 'adiki.ayitevie@newmont.com.gh',
                    'contact': '+233-244-678901',
                    'tax_identification_number': 'P0006789012',
                    'other_directorship': ['Ghana Chamber of Mines']
                }
            ...
            'shareholders': [
                ...
                },
                {
                    ...
                    'address': 'One Airport Square, Accra',
                    'nationality': 'Ghanaian',
                    'occupation': 'Government Agency',
                    'email': 'info@gipc.gov.gh',
                    'contact': '+233-302-789012',
                    'tax_identification_number': 'G0007890123',
                    'shares_alloted': 1600000000,
                    'consideration_payable': 'Cash'
                }
            ],
            'other_linked_companies': [
        ...
        },
        {
            ...
            'directors': [
                ...
                {
                    'name': 'Ms. Sicelo Ntuli',
                    'address': '456 East Legon, Accra',
                    'nationality': 'South African',
                    'occupation': 'Mining Executive',
                    'email': 'sicelo.ntuli@anglogoldashanti.com.gh',
                    'contact': '+233-244-890123',
                    'tax_identification_number': 'P0008901234',
                    'other_directorship': ['AngloGold Ashanti Limited']
                }
            ],
            'secretary': {
                'name': 'Mr. Samuel Osei',
