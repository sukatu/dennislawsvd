#!/usr/bin/env python3
"""
Simple People Generator

This script generates 100 realistic persons for the people table
without importing the ReportedCases model to avoid circular imports.
"""
...
class SimplePeopleGenerator:
    def __init__(self):
        ...
        self.first_names = [
            ...
            "Sosipater", "Justus", "Barabbas", "Matthias", "Barsabbas", "Silas"
        ]
        ...
        self.last_names = [
            ...
            "Gyasi", "Adu", "Bonsu", "Amoako", "Agyei", "Asiedu", "Baffour", "Dankwa",
            "Fosu", "Gyamfi", "Kwarteng", "Nkrumah", "Ofori", "Opoku", "Prempeh", "Yeboah",
            "Acheampong", "Adjei", "Agyemang", "Amoah", "Antwi", "Asante", "Boateng", "Darko",
            "Frimpong", "Gyasi", "Mensah", "Osei", "Owusu", "Quaye", "Sarpong", "Tetteh",
            "Yeboah", "Adu", "Agyei", "Amoako", "Asiedu", "Baffour", "Bonsu", "Dankwa",
            "Fosu", "Gyamfi", "Kwarteng", "Nkrumah", "Ofori", "Opoku", "Prempeh", "Yeboah"
        ]
        ...
        self.cities = [
            ...
            "Mampong", "Ejura", "Bekwai", "Obuasi", "Half Assini", "Aflao", "Keta", "Anloga",
            "Sogakope", "Akatsi", "Kpando", "Hohoe", "Kpandu", "Jasikan", "Kadjebi", "Nkwanta",
            "Kete Krachi", "Dambai", "Krachi", "Chinderi", "Bimbilla"
        ]
...
def main():
    ...
    generator = SimplePeopleGenerator()
