"""
SQLAlchemy model for bank_case_statistics table.
Stores pre-calculated case statistics for each bank.
"""
...
class BankCaseStatistics(Base):
    ...
    bank = relationship("Banks", back_populates="case_statistics")
    
    def __repr__(self):
        return f"<BankCaseStatistics(bank_id={self.bank_id}, total_cases={self.total_cases}, outcome={self.case_outcome})>"
