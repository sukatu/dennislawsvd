...
class BankAnalytics(Base):
    ...
    credit_risk_exposure = Column(DECIMAL(15, 2), default=0.00)
    ...
    bank = relationship("Banks", back_populates="analytics")

    def __repr__(self):
        return f"<BankAnalytics(bank_id={self.bank_id}, risk_score={self.risk_score}, risk_level={self.risk_level})>"
