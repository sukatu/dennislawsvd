...
def list_gazettes(
    ...
    if search:
        search_filter = or_(
            Gazette.title.ilike(f"%{search}%"),
            Gazette.content.ilike(f"%{search}%"),
            Gazette.description.ilike(f"%{search}%"),
            Gazette.reference_number.ilike(f"%{search}%"),
            Gazette.gazette_number.ilike(f"%{search}%")
        )
