...
const CourtManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess(selectedCourt ? 'Court updated successfully!' : 'Court created successfully!');
        ...
        setError(errorData.detail || 'Error saving court. Please try again.');
      }
    } catch (error) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError('Error deleting court. Please try again.');
      }
    } catch (error) {
