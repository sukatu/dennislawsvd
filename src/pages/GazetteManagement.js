...
const GazetteManagement = () => {
  ...
  const loadGazettes = async () => {
    try {
      ...
      const response = await apiGet(`/gazette?${params}`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Gazette Management</h1>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-sm text-gray-600">
            Showing {gazettes.length} of {pagination.total} entries
          </div>
        </div>
