                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            employee.background_check_status === 'completed' 
                              ? 'bg-green-100 text-green-800' 
                              : 'bg-yellow-100 text-yellow-800'
                          }`}>
                            {employee.background_check_status || 'Not completed'}
                          </span>
                        </div>
                        {employee.background_check_date && (
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-600">Date</span>
                            <span className="text-sm text-gray-900">{formatDate(employee.background_check_date)}</span>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center space-x-3 mb-3">
                        ...
                        <h4 className="font-medium text-gray-900">Criminal Record</h4>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-gray-600">Has Criminal Record</span>
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            employee.has_criminal_record 
                        ...
                        {employee.criminal_record_details && (
                          <div>
                            <span className="text-sm text-gray-600">Details</span>
                            <p className="text-sm text-gray-700 mt-1">{employee.criminal_record_details}</p>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    {/* Legal Cases */}
                    {employee.legal_cases && employee.legal_cases.length > 0 && (
                      <div>
                        <h4 className="font-medium text-gray-900 mb-3">Legal Cases</h4>
                        <div className="space-y-3">
                          {employee.legal_cases.map((case_, index) => (
                            <div key={index} className="border border-gray-200 rounded-lg p-4">
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <h5 className="font-medium text-gray-900">{case_.case_title || 'Case Title'}</h5>
                                  <p className="text-gray-600">{case_.case_description || 'Case Description'}</p>
                                  <p className="text-sm text-gray-500 mt-1">
                                    {case_.case_date ? formatDate(case_.case_date) : 'Date not specified'}
                                  </p>
                                </div>
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
