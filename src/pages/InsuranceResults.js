...
import { Shield, MapPin, Phone, Globe, Star, ChevronRight } from 'lucide-react';
...
const InsuranceResults = () => {
  ...
  const loadInsurance = async () => {
    ...
    try {
      ...
      setError('Error loading insurance companies');
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-400">Loading insurance companies...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="mb-8">
          ...
          {query && (
            <div className="text-slate-600 dark:text-slate-400">
              <p>
                Found <span className="font-semibold text-slate-900 dark:text-white">{totalResults}</span> insurance companies 
        ...
        {insurance.length > 0 ? (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-shrink-0">
                    {company.logo_url ? (
                      ...
                      <div className="h-16 w-16 bg-purple-100 dark:bg-purple-900/20 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-2">
                        {company.insurance_type && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-900 dark:text-white">{company.insurance_type}</span>
                          </div>
                        )}
                        ...
                        {company.ownership_type && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-900 dark:text-white">{company.ownership_type}</span>
                          </div>
                        )}
                        ...
                        {company.rating && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-900 dark:text-white">{formatRating(company.rating)}</span>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      ...
                      {company.has_online_portal && (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400">
                          Online Portal
                        </span>
                      )}
                      {company.has_online_claims && (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              Try adjusting your search terms or browse all insurance companies.
            </p>
          </div>
        )}
